...
namespace Wox
{
    public partial class CustomQueryHotkeySetting : Avalonia.Controls.Window
    {
        ...
        public CustomQueryHotkeySetting(SettingWindow settingWidow, Settings settings)
        {
            ...
            this.btnTestActionKeyword.Click += BtnTestActionKeyword_Click;
            this.btnAdd.Click += BtnAdd_Click;
        }


        private void BtnTestActionKeyword_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
