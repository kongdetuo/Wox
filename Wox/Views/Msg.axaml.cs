...
namespace Wox
{
    public partial class Msg :Avalonia.Controls.Window
    {
        ...
        public Msg()
        {
            ...
            //DoubleAnimation fadeOutAnimation = new DoubleAnimation(dipWorkingArea.Y - Height, dipWorkingArea.Y, new Duration(TimeSpan.FromMilliseconds(300)))
            //{
